...
public class PostControllerTestIT {
	...
	public void canFindAll(){
		...
		.then()
			...
			.body("title", Matchers.hasItems("title0", "title1", "title2","title3"));
	}
	...
	public void canAddItem() {
		String body="{\"title\":\"added\",\"cover\":\"addedcover\",\"header\":\"addedheader\",\"content\":\"addedcontent\",\"createdAt\":\""+new Date()+"\",\"createdBy\":\"McGivrer\",\"status\":\""+PublicationState.DRAFT+"\"}";
		expect().statusCode(HttpStatus.SC_OK).given().body(body).post("/posts");
	}
